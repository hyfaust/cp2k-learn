...
Please report this to https://github.com/markedjs/marked.`,e){let s="<p>An error occurred:</p><pre>"+$(n.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(n);throw n}}},S=new M;function u(a,e){return S.parse(a,e)}u.options=u.setOptions=function(a){return S.setOptions(a),u.defaults=S.defaults,ie(u.defaults),u};u.getDefaults=N;u.defaults=R;u.use=function(...a){return S.use(...a),u.defaults=S.defaults,ie(u.defaults),u};u.walkTokens=function(a,e){return S.walkTokens(a,e)};u.parseInline=S.parseInline;u.Parser=y;u.parser=y.parse;u.Renderer=A;u.TextRenderer=P;u.Lexer=w;u.lexer=w.lex;u.Tokenizer=z;u.Hooks=T;u.parse=u;var Ve=u.options,Ye=u.setOptions,et=u.use,tt=u.walkTokens,nt=u.parseInline;var st=y.parse,rt=w.lex;window.marked=u;})();
